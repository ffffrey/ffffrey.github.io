...
img: assets/img/torus_membrane.jpg
importance: 1
#category: work
...
<div class="row">
    <div class="col-sm mt-2 mt-md-0">
        {% include figure.liquid path="assets/img/torus_membrane.jpg" title="example image" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-2 mt-md-0">
        {% include figure.liquid path="assets/img/bridge_membrane.jpg" title="example image" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
